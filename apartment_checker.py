...
class ApartmentChecker:
    ...
    def parse_apartment_details(self, html_content):
        ...
        # Also try to find apartment data in JSON-LD or data attributes
        json_matches = re.findall(r'<script[^>]*type=["\']application/ld\+json["\'][^>]*>(.*?)</script>', html_content, re.DOTALL | re.I)
    ...
    def get_apartment_data(self):
        try:
            ...
            # Create SSL context that doesn't verify certificates (for this specific use case)
